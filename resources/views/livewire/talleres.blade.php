                                        ...
                                        <tr>
                                            ...
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                ...
                                                <div class="flex justify-end space-x-2">
                                                    <a wire:click="edit({{ $item }})"  href="{{ route('editar-taller',$item->id)}}" {{--esto estaba en comentario antes href="{{ route('editar-taller',$item->id)}}" --}}
                                                    ...
                                                    @if ($this->obtieneServiciosDisponibles($item)->count() > 0)
                                                        <button data-tooltip-target="tooltip-dark" type="button"
                                                            class="group flex py-4 px-4 text-center rounded-md bg-orange-300 font-bold text-white cursor-pointer hover:bg-orange-400 hover:animate-pulse"
                                                            wire:click="agregarServicios({{ $item }})">
            ...
            <div>
              ...
              --}}
                                <div x-data="{ open: false }"
                                    ...
                                    <div @click="open = ! open"
                                        class="bg-green-100 p-4 w-full flex justify-between items-center">
                                    ...
                                    <div x-show="open" @click.outside="open = false"
                                        ...
                                        <div class="flex flex-row w-full divide-x divide-gray-400/20">
                                            <div class="px-8 py-4 bg-green-100/30 w-2/3 ">
                                                ...
                                                <p class="text-gray-500 text-xs">
                                                    ...
                                                    <span class="font-bold">
                                                        {{ date('d-m-Y', strtotime($doc->fechaInicio)) }} </span>
                                                </p>
                                                <p class="text-gray-500 text-xs">
                                            ...
                                            <div
                                                class="bg-green-100/30 w-1/3 flex justify-center space-x-2 items-center px-3">
                                                <a href="{{ Storage::url($doc->ruta) }}" rel="nonopener nonreferer"
                                                    target="__blank"
                                                ...
                                                <a href="{{ route('download_doctaller', $doc->id) }}"
    ...
    <x-jet-dialog-modal wire:model="agregando" wire:loading.attr="disabled">
        ...
        <x-slot name="content">
            ...
            --}}
                    <div class="flex flex-row justify-between bg-indigo-100 my-2 items-center rounded-lg p-2">
                        <div class="">
                            <input wire:model="serviciosNuevos.{{ $key }}.estado"
                                class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white outline-transparent checked:bg-indigo-600 checked:border-indigo-600 outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                                type="checkbox">
                            <label class="form-check-label inline-block text-gray-800">
                        ...
                        <div class="flex flex-row items-center">
                            <x-jet-label value="precio:" />
                            <x-jet-input type="number" class="w-6px"
                                wire:model="serviciosNuevos.{{ $key }}.precio" />
                        </div>
